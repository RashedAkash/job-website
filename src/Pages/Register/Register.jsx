  ...
  return (
	...
	<form onSubmit={handleSubmit} action="" className="space-y-6">
		<div className="space-y-1 text-sm">
			...
			<input type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 border focus:dark:border-violet-400" />
		</div>
		<div className="space-y-1 text-sm">
		...
		<div className="space-y-1 text-sm">
			...
			<input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 border focus:dark:border-violet-400" />
		...
		<div className="space-y-1 text-sm">
			...
			<input type="text" name="photo" id="photo" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 border focus:dark:border-violet-400" />
			<div className="flex justify-end text-xs dark:text-gray-400">
				<a rel="noopener noreferrer" href="#">Forgot Password?</a>
			</div>
		</div>
